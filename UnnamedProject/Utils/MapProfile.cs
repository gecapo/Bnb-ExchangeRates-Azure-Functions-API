    ...
    public class MapProfile : Profile
    {
        public MapProfile()
        {
            CreateMap<BnbExcangeRatesResponse, BnbExcangeRates>()
                ...
                //TableMap
                .ForMember(destinationEntity => destinationEntity.PartitionKey, options => options.MapFrom(sourceEntity => DateTime.ParseExact(sourceEntity.Date, "dd.MM.yyyy", null).ToString()))
