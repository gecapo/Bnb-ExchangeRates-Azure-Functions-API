    ...
    public class MapProfile : Profile
    {
        public MapProfile()
        {
            CreateMap<BnbExcangeRatesResponse, BnbExcangeRates>()
                ...
                .ForMember(destinationEntity => destinationEntity.ReportDate, options => options.MapFrom(sourceEntity => DateTime.ParseExact(sourceEntity.Date, "dd.MM.yyyy", null).ToUniversalTime()))
                ...
                //TableMap
                .ForMember(destinationEntity => destinationEntity.PartitionKey, options => options.MapFrom(sourceEntity => DateTime.ParseExact(sourceEntity.Date, "dd.MM.yyyy", null).ToUniversalTime().ToString("yyyyMMdd")))
